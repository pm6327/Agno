...
agent.print_response(
    "Write a 300 word summary on the topic: 'AI Agents and its future'. Use the latest information to generate the response."
)

agent.print_response(
    "add key points from the summary generated above. The number of points depends on the summary"
)

agent.print_response("What topic are we talking about?")

agent.print_response(
    "List down the key points from the recent summary generated for me in proper format"
)
