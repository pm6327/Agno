...
agent.print_response(
    "I have already bought apple, please add banana and oranges to the list",
    session_id=fruits_session,
)

agent.print_response(
    "Clear the list and add pineapple to it", session_id=fruits_session
)
print("Fruit list", agent.get_session_state(fruits_session))

agent.print_response(
    "Add curd and butter to the list, and remove milk from the list",
    session_id=dairy_session,
)
