...
# create the model
# this is a a paid model so it won't give any output

llm = OpenAIChat(id="gpt-4.1-mini")

# add user id , we can also work with multiple users at a time
user_id = "user1"
...
# creating multiple sessions for diff conversations
...
agent.print_response(
    input="can you list down the advantages of RAG you talked about earlier. Only list down from previous chat",
